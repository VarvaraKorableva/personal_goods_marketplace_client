...
const rus = {
    ...
    choiseASubCategory: 'Выберите cубкатегорию товара (не обязательно)',
    choiseASubCategoryOfServices: 'Выберите cубкатегорию (не обязательно)',
    choiseASecondSubCategoryGoods: 'Выберите cубкатегорию (не обязательно)',
